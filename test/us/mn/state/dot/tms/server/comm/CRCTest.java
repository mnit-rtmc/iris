...
public class CRCTest extends TestCase {
	...
	public void testDARC() {
		...
		assertTrue(crc.checksum(CHECK) == 0x15);
	}
	...
	public void testEBU() {
		...
		assertTrue(crc.checksum(CHECK) == 0x97);
	}

	public void testICODE() {
		CRC crc = new CRC(8, 0x1D, 0xFD, false);
		assertTrue(crc.checksum(CHECK) == 0x7E);
	}

	public void testITU() {
		CRC crc = new CRC(8, 0x07, 0x00, false, 0x55);
		assertTrue(crc.checksum(CHECK) == 0xA1);
	}
