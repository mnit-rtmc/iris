...
class WTagParamSonarObjectField<SonarObject> extends JComboBox<SonarObject>
	...
	public WTagParamSonarObjectField(ComboBoxModel<SonarObject> model,
	...
	public SonarObject getSelectedItem() {
		return (SonarObject) super.getSelectedItem();
	}
}
