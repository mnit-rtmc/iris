...
public class NotificationProxyPanel extends ProxyTablePanel<Notification> {
	...
	public NotificationProxyPanel(ProxyTableModel<Notification> m,
	...
	public void setForm(NotificationForm f) {
		form = f;
	}
	...
	private void goToRefObject() {
		...
		Notification pn = getSelectedProxy();
		...
		session.getNotificationManager().checkStopBlinkBG();
