...
/**
 * Panel for incident locators.
 *
 * @author Douglas Lau
 */
public class IncLocatorPanel extends ProxyTablePanel<IncLocator> {
	...
	/** Incident locator model */
	private final IncLocatorTableModel model;

	/** Create a new incident locator panel */
	public IncLocatorPanel(IncLocatorTableModel m) {
		super(m);
		model = m;
	}
