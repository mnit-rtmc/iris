...
public enum SystemAttrEnum {
	...
	COMM_IDLE_DISCONNECT_DMS_SEC(-1, -1, 28800),    // 8-hours max
	COMM_IDLE_DISCONNECT_GPS_SEC(5, -1, 28800),     // 8-hours max
	COMM_IDLE_DISCONNECT_MODEM_SEC(20, -1, 28800),  // 8-hours max
