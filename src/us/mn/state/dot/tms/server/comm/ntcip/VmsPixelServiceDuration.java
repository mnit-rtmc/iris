	...
	implements ASN1Integer
{
	...
	/** Get the object name */
	protected String getName() { return "vmsPixelServiceDuration"; }

	/** Pixel service duration (in seconds) */
	protected int duration;

	/** Set the integer value */
	public void setInteger(int value) { duration = value; }

	/** Get the integer value */
	public int getInteger() { return duration; }

	/** Get the object value */
	public String getValue() { return String.valueOf(duration); }
}
