...
/**
 * This class performs a VAPIX request for a continuous iris movement.
 *
 * @author Travis Swanston
 */
public class IrisProperty extends AxisPTZProperty {

	/** Requested iris value */
		...
		throws IOException
	{
		...
		cmd.addParam(VapixCmd.PARAM_IRIS, iris);
