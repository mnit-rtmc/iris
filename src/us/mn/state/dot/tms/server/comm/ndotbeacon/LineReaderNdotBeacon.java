...
public class LineReaderNdotBeacon extends LineReader {
	 ...
	 * @param max_chars Maximum number of characters on a line. */
	public LineReaderNdotBeacon(InputStream is, int max_chars)
			throws IOException {
		super(is, max_chars);
	}
