	...
	implements ASN1Integer
{
	...
	/** Get the object name */
	protected String getName() { return "vmsPixelServiceFrequency"; }

	/** Pixel service frequency (in minutes) */
	protected int frequency;

	/** Set the integer value */
	public void setInteger(int value) { frequency = value; }

	/** Get the integer value */
	public int getInteger() { return frequency; }

	/** Get the object value */
	public String getValue() { return String.valueOf(frequency); }
}
