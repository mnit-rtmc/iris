...
public class KAdaptiveAlgorithm implements MeterAlgorithmState {
    ...
    protected LimitedQueue<Double> corridorKHistory = new LimitedQueue<Double>(avgDensityWindow + avgDensityTrend);    
    ...
    class StationState extends RNodeState {
        ...
        /** Speed history */
        LimitedQueue<Double> speedHistory = new LimitedQueue<Double>(10);
        
        /** Density history */
        LimitedQueue<Double> densityHistory = new LimitedQueue<Double>(10);
         ...
         */
        private double getAggregatedData(LimitedQueue<Double> data, int prevStep) {
    ...
    class EntranceState extends RNodeState {
        ...
        private LimitedQueue<Double> cumulativeDemand = new LimitedQueue<Double>(maxWaitTimeIndex+1);
        ...
        public void checkFreewayToFreeway()
        {
            ...
            if(rnode.geo_loc == null) return;
            String mod = GeoLocHelper.getModifier(rnode.geo_loc);
            if(rnode.geo_loc.getCrossMod() == 0) mod = "";            
