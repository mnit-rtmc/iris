...
public class KmlFile {
	...
	/** KML file name */
	static private final String KML_FILENAME =
		"/var/www/html/iris_xml/iris.kmz";

	/** newline */
	static private final String R = "\n";

	/** kml file author comment */
	static private final String AUTHOR_NOTE =
	...
	static public void writeServerFile(KmlDocument doc) {
		if(doc == null)
			return;
		if(!SystemAttrEnum.KML_FILE_ENABLE.getBoolean())
			return;
		KmlFile kf = new KmlFile(doc);
		if (!kf.writeKmlKmz(KML_FILENAME))
			System.err.println("Failed to write " + KML_FILENAME);
	}
}
