...
/**
 * TimeoutException is thrown when there is a serial I/O timeout error.
 *
 * @author Douglas Lau
 */
public class TimeoutException extends SerialIOException {

	/** Create a new timeout exception */
	public TimeoutException() {
		super("SERIAL I/O TIMEOUT ERROR");
	}
