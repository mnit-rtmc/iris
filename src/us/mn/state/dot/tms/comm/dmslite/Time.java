...
final public class Time {
	...
	public static boolean test() {
		...
		if(!Time.verifyDefaultTimeZone("Pacific Standard Time")) {
			System.err.println(
		...
		// Time.subtract
		{
			...
			System.err.println("          Current Time (UTC):"
				 + Time.getCurTimeSparseString(d, false));
			System.err.println("          Current Time (loc):"
				 + Time.getCurTimeSparseString(d, true));
			System.err.println("  Current Time minus 20 mins:"
				 + Time.getCurTimeSparseString(Time.subtract(d,
					 20 * 60 * 1000), false));
		...
		// Time.XMLtoDate
		{
			System.err.println("Time.XMLtoDate():" + ok);

			// this date is within DST so should convert to GMT-7
			Date d1 = Time.XMLtoDate("2008-04-29T15:37:22Z");
		...
		/*
		{
			...
			String xml = Time.toXMLDateTime(d);
		...
		*/
		...
		// Time.XMLtoCalendar
		{
			System.err.println("Time.XMLtoCalendar():" + ok);

			Calendar c1 =
				Time.XMLtoCalendar("2008-04-29T15:37:22Z");
		...
		// Time.CalendarToXML
		{
			System.err.println("Time.CalendarToXML():" + ok);

			// local time
			Calendar c =
				new GregorianCalendar(2008, 4 - 1, 29, 8, 53,
						      31);    // local time in DST
			String xml = Time.CalendarToXML(c);
		...
		// DST conversions
		{
			...
			System.err.println("Time.DST default zone:" + ok);
			...
			System.err.println("Time.DST conversions with default zone:"
				 + ok);
			c = new GregorianCalendar();
	...
	public static String CalendarToXML(java.util.Calendar c) {
		...
		assert x.length() == 20 : "Time.CalendarToXML";
