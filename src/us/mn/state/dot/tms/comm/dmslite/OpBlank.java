...
public class OpBlank extends OpDms {
    ...
    protected class PhaseSetBlank extends Phase {
        ...
        protected Phase poll(AddressedMessage argmess) throws IOException {
            ...
            System.err.println("dmslite.OpBlank.PhaseGetConfig.poll(msg) called. m_mess.duration="+m_mess.getDuration());
            ...
            if (m_mess.getDuration() > 0) {
                System.err.println("Bogus duration received in OpBlank.PhaseSetBlank().");
	    ...
	    // drop
            ...
            ReqRes rr1 = new ReqRes("Address", drop, new String[] { "IsValid", "ErrMsg" });
            mess.add(rr1);
		...
		if (!valid && errmsg.length()<1)
			errmsg="request failed";
                ...
                // valid resp received?
                System.err.println("dmslite.OpBlank.PhaseSetBlank.poll(): success="+valid);
            } catch (IllegalArgumentException ex) {
                System.err.println("Malformed XML received in dmslite.OpBlank.PhaseSetBlank.poll(msg):" + ex+",id="+id);
		valid = false;
		...
		if(flagFailureShouldRetry(errmsg)) {
			System.err.println("OpBlank: will retry failed operation");
			return this;
		}
	    }
