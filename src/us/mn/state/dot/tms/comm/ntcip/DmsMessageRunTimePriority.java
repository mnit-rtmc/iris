	...
	implements ASN1Integer
{
	...
	/** Get the object name */
	protected String getName() { return "dmsMessageRunTimePriority"; }

	/** Get the message table item (for dmsMessageRunTimePriority) */
	protected int getTableItem() { return 8; }

	/** Message run time priority */
	protected int priority;

	/** Set the integer value */
	public void setInteger(int value) { priority = value; }

	/** Get the integer value */
	public int getInteger() { return priority; }

	/** Get the object value */
	public String getValue() { return String.valueOf(priority); }
}
