...
public class DmsMessageStatus extends DmsMessageTable implements ASN1Integer {
	...
	/** Get the object name */
	protected String getName() { return "dmsMessageStatus"; }

	/** Get the message table item (for dmsMessageStatus objects) */
	protected int getTableItem() { return 9; }
	...
	public boolean isModifying() { return status == MODIFYING; }

	/** Is the status "valid"? */
	public boolean isValid() { return status == VALID; }
