...
public class DmsMsgSourceMode extends SignControl implements ASN1Integer {
	...
	/** Get the object name */
	protected String getName() { return "dmsMsgSourceMode"; }
	...
	public void setInteger(int value) {
		source = value;
		if(source < 0 || source >= SOURCE.length)
			source = UNDEFINED;
	}

	/** Get the integer value */
	public int getInteger() { return source; }

	/** Get the object value */
	public String getValue() { return SOURCE[source]; }
}
