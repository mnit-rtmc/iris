 ...
 * @author Douglas Lau
 */
public class LedPixelLow extends LedstarSignControl implements ASN1Integer {
	...
	/** Get the object name */
	protected String getName() { return "LedPixelLow"; }

	/** Pixel low current limit (milliamperes) */
	protected int limit;
