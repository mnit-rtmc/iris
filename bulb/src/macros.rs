...
macro_rules! cards_meth {
    ($cards:ident, $meth:ident) => {
        match $cards.res {
            ...
            Res::DayPlan => $cards.$meth::<DayPlan>().await,
            Res::Detector => $cards.$meth::<Detector>().await,
            Res::Dms => $cards.$meth::<Dms>().await,
            Res::Domain => $cards.$meth::<Domain>().await,
            Res::EncoderType => $cards.$meth::<EncoderType>().await,
            Res::EventConfig => $cards.$meth::<EventConfig>().await,
            ...
            Res::MapExtent => $cards.$meth::<MapExtent>().await,
            Res::MonitorStyle => $cards.$meth::<MonitorStyle>().await,
            Res::MsgLine => $cards.$meth::<MsgLine>().await,
            Res::MsgPattern => $cards.$meth::<MsgPattern>().await,
            Res::PlanPhase => $cards.$meth::<PlanPhase>().await,
            Res::RampMeter => $cards.$meth::<RampMeter>().await,
            //Res::Rnode => $cards.$meth::<Rnode>().await,
            Res::Road => $cards.$meth::<Road>().await,
            ...
            Res::TollZone => $cards.$meth::<TollZone>().await,
    ...
    ($cards:ident, $meth:ident, $param:expr) => {
        match $cards.res {
            ...
            Res::DayPlan => $cards.$meth::<DayPlan>($param).await,
            Res::Detector => $cards.$meth::<Detector>($param).await,
            Res::Dms => $cards.$meth::<Dms>($param).await,
            Res::Domain => $cards.$meth::<Domain>($param).await,
            Res::EncoderType => $cards.$meth::<EncoderType>($param).await,
            Res::EventConfig => $cards.$meth::<EventConfig>($param).await,
            ...
            Res::MapExtent => $cards.$meth::<MapExtent>($param).await,
            Res::MonitorStyle => $cards.$meth::<MonitorStyle>($param).await,
            Res::MsgLine => $cards.$meth::<MsgLine>($param).await,
            Res::MsgPattern => $cards.$meth::<MsgPattern>($param).await,
            Res::PlanPhase => $cards.$meth::<PlanPhase>($param).await,
            Res::RampMeter => $cards.$meth::<RampMeter>($param).await,
            //Res::Rnode => $cards.$meth::<Rnode>($param).await,
            Res::Road => $cards.$meth::<Road>($param).await,
            ...
            Res::TollZone => $cards.$meth::<TollZone>($param).await,
