...
UPDATE iris.system_attribute SET value = '' WHERE name = 'email_sender_client';
...
DELETE FROM iris.i_user_domain;
DELETE FROM iris.i_user;
...
INSERT INTO iris.i_user (name, full_name, password, dn, role, enabled)
