 ...
 * @version $Revision: 1.3 $ $Date: 2003/09/22 18:29:21 $
 */
public class NdsUserManagerTest extends TestCase implements LoginListener {
	
	private boolean login = false;
	
	private boolean logout = false;
	
	private final NdsUserManager manager = new NdsUserManager();
	
	public NdsUserManagerTest( String testName ) {
		super( testName );
	}
	...
	public static Test suite() {
		TestSuite suite = new TestSuite( NdsUserManagerTest.class );
		return suite;
	}
