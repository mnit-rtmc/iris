 ...
 * @version $Revision: 1.3 $ $Date: 2003/09/22 18:29:09 $
 */
public class LdapUserManagerTest extends TestCase implements LoginListener {
	
	private boolean login = false;
	
	private boolean logout = false;
	
	private final UserManager manager = new LdapUserManager();
	
	public LdapUserManagerTest( String testName ) {
		super( testName );
	}
	...
	public static Test suite() {
		TestSuite suite = new TestSuite( LdapUserManagerTest.class );
		return suite;
	}
