...
impl Resource {
    ...
    const fn all_sql(self) -> &'static str {
        ...
        match self {
            ...
            CommState => query::COMM_STATE_LUT,
            ...
            IncDetail => query::INC_DETAIL_ALL,
            ...
            MapExtent => query::MAP_EXTENT_ALL,
            ...
            PhaseAction => query::PHASE_ACTION_ALL,
